...
const Login = () => {
  ...
  const handleSubmit = async e => {
    ...
    const success = await dispatch(userslogin(formData));
    if (success) {
            ...
            <div className="card card-body">
              ...
              <form onSubmit={e => handleSubmit(e)}>
                ...
                <div className="form-group text-center mt-3 mb-2">
                  <button type="submit" className="btn btn-primary text-uppercase custom-label">{loading ? 'logging....' : role === 'superadmin' ? 'Continue' : 'Login'}</button>
                </div>
                <div className="form-group">
