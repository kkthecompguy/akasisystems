...
import { resolveIssue } from '../../actions/superadmin';
...
const Issues = ({ issues, addressIssues }) => {
  ...
  const handleSubmit = async () => {
    if (message.trim() === "") {
      ...
      await dispatch(resolveIssue(message, selectedIssue));
      setMessage('');
  ...
  return (
    <main>
      ...
      { toggleIssues === "ALL ISSUES" ? <div className="issues-addressed-to-me"><button onClick={() => setToggleIssues("ADDRESS TO ME")} className="btn btn-primary">View Issues Addressed To Me <i className="las la-arrow-circle-right"></i></button></div>: <div className="issues-addressed-to-me"><button onClick={() => setToggleIssues("ALL ISSUES")} className="btn btn-primary"><i className="las la-arrow-circle-right"></i> View Issues<i className="las la-arrow-circle-left"></i></button></div> }
      ...
      { toggleIssues === "ALL ISSUES" && (
        ...
        <div className="generate-report">
          <button onClick={() => handleAllReports(issues)} className="btn btn-primary custom-label text-uppercase">Generate Report</button>
        </div>
        </>
      ) }
      ...
      { toggleIssues === "ADDRESS TO ME" && (
        ...
        <div className="generate-report">
          <button onClick={() => handleAddressedReports(addressIssues)} className="btn btn-primary custom-label text-uppercase">Generate Report</button>
        </div>
        </>
      ) }
